...
class CardTests(unittest.TestCase):
    ...
    def test_init(self):
        """checks if card have suit and value"""
...
class DeckTests(unittest.TestCase):
    ...
    def test_deal_no_cards(self):
        """_deal should return a valueError if the deck is empty"""
    ...
    def test_shuffle_full_deck(self):
        """shuffle should shuffle the deck only if the deck is full"""
